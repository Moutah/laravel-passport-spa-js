...
describe('utils', () => {
  ...
  //       });
  //     } catch (error) {
  //       expect(error.message).toBe(`HTTP error. Unable to fetch https://test.com/oauth/token`);
  ...
  //         }, 10);
  //         jest.useFakeTimers();
  //         await expect(runPopup(url, { popup })).rejects.toMatchObject(TIMEOUT_ERROR);
  //         jest.useRealTimers();
  //       });
  //     });
  //   });
  ...
  //     await expect(runPopup(url, { popup })).resolves.toMatchObject(message.data.response);
  ...
  //     await expect(runPopup(url, { popup })).rejects.toMatchObject(message.data.response);
  ...
  //     await expect(runPopup(url, {})).resolves.toMatchObject(message.data.response);
  ...
  //     };
  //     const url = 'https://authorize.com';
  //     const origin = (customMessage && customMessage.origin) || 'https://origin.com';
  //     window.addEventListener = <any>jest.fn((message, callback) => {
  //       expect(message).toBe('message');
  //       callback(customMessage);
  //     });
  ...
  //     const { iframe, url } = setup(message);
  //     jest.useFakeTimers();
  //     await expect(runIframe(url, origin)).resolves.toMatchObject(message.data.response);
  //     jest.runAllTimers();
  //     expect(message.source.close).toHaveBeenCalled();
  //     expect(window.document.body.removeChild).toHaveBeenCalledWith(iframe);
  //   });
  ...
  //     const { iframe, url } = setup(message);
  //     jest.useFakeTimers();
  //     await expect(runIframe(url, origin)).rejects.toMatchObject(message.data.response);
  //     jest.runAllTimers();
  //     expect(message.source.close).toHaveBeenCalled();
  //     expect(window.document.body.removeChild).toHaveBeenCalledWith(iframe);
  //   });
